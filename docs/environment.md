...
| `REDLINE_DISPLAY_<ROLE>_CONNECTOR` `_MODE` `_PROFILE` | `redline-display-setup` on the image | The detected display modules; the dashboard binds windows to them. See [displays.md](displays.md). |
