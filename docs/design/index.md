...
| [State estimation](state-estimation.html) | Frames, why our own fixed-lag smoother, FEJ, what cannot be observed, time alignment without PPS, GNSS pairing by arrival, the bugs that shaped the code, measured accuracy and NEES, and what is unverified. | [state_estimator](../nodes/state_estimator.html), [estimator_offline](../tools/estimator_offline.html) |
| [csym constant-evaluation limits](csym-constexpr.html) | What constant evaluation costs on clang and GCC, what was tried, and why csym builds its tape the way it does. | [csym](../libs/csym.html) |
